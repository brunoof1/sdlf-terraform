...
object GlueApp {
  def main(sysArgs: Array[String]) {
    ...
    for (tabName <- tabNames) {
      logger.info("Reading Source database: " + dbName + " and table: " + tabName + " for team: " + team)
      ...
      logger.info("Running Constraint Suggestor for database: " + dbName + "and table: " + tabName + " for team: " + team)
    ...
    def verificationRunner(glueDF: DataFrame, allConstraints: Seq[com.amazon.deequ.constraints.Constraint], team: String, dataset: String, tabName: String, getYear: String, getMonth: String, getDay: String, getTimestamp: String) = {
      ...
      writeDStoS3(resultDataFrame, args("targetBucketName"), "constraints-verification-results", team, dataset, tabName, getYear, getMonth, getDay, getTimestamp)
    }
    ...
    def analysisRunner(glueDF: DataFrame, allConstraints: Seq[com.amazon.deequ.constraints.Constraint], team: String, dataset: String, tabName: String, getYear: String, getMonth: String, getDay: String, getTimestamp: String) = {
      ...
      writeDStoS3(resultDataFrame, args("targetBucketName"), "constraints-analysis-results", team, dataset, tabName, getYear, getMonth, getDay, getTimestamp)
    }
